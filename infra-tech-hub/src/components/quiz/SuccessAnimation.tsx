      ...
      <div className="relative">
        {showCheckmark && (
          <div className="relative flex items-center justify-center">
            {/* 緑のリング（中身透明） */}
            <div className="relative w-28 h-28 rounded-full border-4 border-emerald-400 transform scale-0 animate-[scale-in_0.6s_ease-out_forwards]" style={{ boxShadow: '0 0 40px rgba(52, 211, 153, 0.6), 0 0 80px rgba(52, 211, 153, 0.3)' }}>
              {/* 内側のハイライトリング */}
